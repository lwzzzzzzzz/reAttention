...
class Graph():
    def __init__(self, is_training=True):
        ...
        with self.graph.as_default():
            ...
            self.logits = tf.layers.dense(self.dec, len(en2idx)) #(N, T, vocab_len)
            ...
            if is_training:
                ...
                # 如果索引值大于int大小，则整行都是0.
                self.y_smoothed = label_smoothing(tf.one_hot(self.y, depth=len(en2idx))) #y_smoothed因为one_hot变成了(N, T, vocab_len)
